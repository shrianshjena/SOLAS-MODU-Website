...
export const metadata = pageMetadata(termsPage.meta);

const bodySections = termsPage.sections.slice(0, -1);
const closing = termsPage.sections[termsPage.sections.length - 1];

/**
 * /terms: contour-field PageHero (no image), the terms sections on the
      ...
      <main id="main">
        ...
        <section data-nav-theme="light" className="u-chart-border bg-surface">
          <div className="u-shell py-[clamp(4.5rem,10vh,8rem)]">
            <AISReadout text={termsPage.effectiveDate} tone="onLight" />
